          ...
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-xl p-2 flex items-center">
            ...
            <div className="flex-1 relative">
              <Input 
                ...
                className="w-full border border-[#F5F4F8] border-l-0 hover:border-l-0 focus:border-l-0 rounded-l-none text-gray-600 focus-visible:ring-0 text-xs sm:text-sm md:text-base pr-12"
              />
